        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerifyEmailToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastSendEmailDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthField = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { (byte)1, "Muhendislik Fakültesi" },
                    { (byte)2, "Edebiyat Fakültesi" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, false, "Admin", null },
                    { 2, null, false, "User", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { (byte)1, (byte)1, "Bilgisayar Mühendisliği" },
                    { (byte)2, (byte)1, "Makine Mühendisliği" },
                    { (byte)3, (byte)1, "Elektrik Elektronik Mühendisliği" },
                    { (byte)4, (byte)1, "Endüstri Mühendisliği" },
                    { (byte)5, (byte)2, "Türk Dili ve Edebiyatı" },
                    { (byte)6, (byte)2, "İngiliz Dili ve Edebiyatı" },
                    { (byte)7, (byte)2, "Psikoloji" }
                });
